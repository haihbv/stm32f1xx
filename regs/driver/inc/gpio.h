 ...
 * @attention
 *
 * This module provides low-level access to STM32F1xx GPIO (General Purpose I/O)
 * peripheral registers using union-based bit-field structures for efficient
 * register manipulation and pin control.
 *
 ******************************************************************************
 */
...
#include "stm32_util.h"
     ...
     * @note   Defines the logical state of a GPIO pin
     */
    typedef enum
    {
     ...
     * @note   Defines the operating mode and configuration of GPIO pins:
     *         - Input modes: floating, pull-up, pull-down, analog
     *         - Output modes: push-pull, open-drain with different speeds
     ...
     * @note   Defines the maximum output speed for GPIO pins in output mode.
     *         Higher speeds provide faster slew rate but increase power consumption
     ...
     * @note   This structure contains the configuration information for GPIO pins
     */
    typedef struct
    {
